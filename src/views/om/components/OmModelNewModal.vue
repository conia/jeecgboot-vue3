...
<script lang="ts" setup>
    ...
    import {formSchema,omModelDataColumns} from '../OmModelNew.data';
    import {saveOrUpdate,omModelDataList} from '../OmModelNew.api';
    ...
    const [registerModal, {setModalProps, closeModal}] = useModalInner(async (data) => {
        ...
        if (unref(isUpdate)) {
            ...
            await setFieldsValue({
             ...
             requestSubTableData(omModelDataList, {id:data?.record?.id}, omModelDataTable)
        }
        // 隐藏底部时禁用整个表单
    ...
    async function reset(){
      await resetFields();
      activeKey.value = 'omModelData';
      omModelDataTable.dataSource = [];
    }
